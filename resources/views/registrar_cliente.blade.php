...
<body class="flex justify-end w-screen h-screen min-h-screen bg-login_img bg-cover bg-no-repeat bg-right 
    ...
    <div class="w-2/5 h-full px-10 flex flex-col justify-center items-stretch rounded-s-2xl bg-color-bg shadow-lg text-white
        ...
        <form method="POST" action="{{ route('registrar.cliente') }}">
            @csrf
            <div class="flex justify-stretch border-2 border-slate-800 rounded-lg mb-5 p-2 focus:border-orange-500 bg-color-secondary">
                <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" lass="max-md:w-auto max-md:h-fill">
                    <path d="M5 21C5 17.134 8.13401 14 12 14C15.866 14 19 17.134 19 21M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <input type="text" name="nombre" placeholder="Nombre" required 
                class="w-full h-auto text-lg 5 outline-none ms-2 bg-transparent">
            </div>
            <div class="flex justify-stretch border-2 border-slate-800 rounded-lg mb-5 p-2 focus:border-orange-500 bg-color-secondary">
